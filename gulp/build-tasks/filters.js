...
gulp.task('build:filters', gulp.parallel([
  ...
  'build:filters:unknown-risk-services-local',
  'build:filters:unknown-risk-services-web',
  ...
  'build:filters:critical-services-local',
  'build:filters:critical-services-web',
